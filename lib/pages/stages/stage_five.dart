...
class StageFourVehicle extends GetView<StageThreeController> {
  const StageFourVehicle({super.key});
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Center(
                              child: txt25Size(
                                  title:
                                      "${controller.labelTextDetail['main_heading'] ?? "Step 4 of 5 - Vehicle Information"}",
                                  context: context)),
                          5.heightBox,
                          txt16Size(
                              title:
